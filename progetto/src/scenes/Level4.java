...
* @file Level4.java 
* 
* @brief file per gestire tutto cio che è presente nel level4.
*
*/
package scenes;
...
* oggetti dei nemici e di tutti gli elementi contenuti dal level4
* 
*/ 
...
public class Level4 extends GameScene implements SceneMethods {
...
//    }
    ...
    private void drawSelectedTower(Graphics g) {
        if (selectedTower != null) { 
            g.drawImage(towermanager.getTowerImgs()[selectedTower.getTypetower()-9][0], mouseX, mouseY, Tile.spriteWidth, Tile.spriteHeight, null);
        }
    }
